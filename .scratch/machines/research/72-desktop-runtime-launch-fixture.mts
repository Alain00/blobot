...
const codexOnly = process.env.BLOBOT_RESEARCH72_CODEX_ONLY === '1';
const reportPath = new URL(codexOnly ? './72-codex-after-allowlist-results.json' : './72-desktop-runtime-launch-results.json', import.meta.url);
...
try {
  ...
  for (const runtimeId of codexOnly ? ['codex'] : ['codex', 'opencode', 'cursor']) {
