 ...
 *
 * The second is the one that matters as the runtime list grows. Codex and Gemini will land as
 * detections before anybody goes and fetches their marks, and a placeholder glyph in that gap
 * would be blobot inventing a face for a product that has one.
 */
...
describe('a runtime’s own mark', () => {
  ...
  it('draws nothing at all for an id it does not know', () => {
    ...
    expect(draw('codex').innerHTML).toBe('');
